...
#if UNITY_EDITOR
        [CustomEditor(typeof(FMODStudioChangeMusicBasedOnDirection))]
                public class FMODStudioChangeMusicBasedOnDirectionEditor : Editor
                {
                    ...
                    {
                FMODStudioChangeMusicBasedOnDirection targetScript = (FMODStudioChangeMusicBasedOnDirection)target;
