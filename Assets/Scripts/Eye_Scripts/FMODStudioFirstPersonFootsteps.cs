...
namespace FMODUnity
{
    public class FMODStudioFirstPersonFootsteps : MonoBehaviour
    {
        ...
        [SerializeField] EventReference FootstepsEventPath;    // Use this in the Editor to select our Footsteps Event.
        [SerializeField] EventReference JumpingEventPath;      // Use this in the Editor to select our Jumping Event.
